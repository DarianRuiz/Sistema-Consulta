...
<body>
	<h1 style="margin-left:40% ;margin-top:80px"   class="asd"> Citas </h1>
	<table class="table4">
		<tr>
		<th>ID citas</th>
		<th>ID doctor</th>
	   ...
	   <h1 style="margin-left:37% ;margin-top:70px"   class="asd">Enviar confirmacion Email </h1>
    ...
    <div classs="xa" style="margin-top:0px">
        ...
        <label for="subject" style="margin:10px ;display: inline-block;">Tema</label>
        <input type="text"  id="subject" name="subject" maxlength="50" style="width:400px;" placeholder="Confirmacion de cita">
        
        <label for="name" style="margin:10px ;display:inline-block;" >Mensaje</label>
        <input type="text" placeholder="Mensaje de confirmacion de cita:" type="textarea"  id="message" name="message" rows="1" style="width:400px;padding-top: 10px" maxlength="2000">
               
               
        
        <button type="submit"  id="message" name="sendemail" style="width:200px;height:30px;border-radius: 10px; background: #992828 ;margin-left:45%;color: white ">Enviar
               </button>

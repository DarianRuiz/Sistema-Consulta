...
<div class="contentP" style="font-weight: bold;">
	...
	<label>ID: <?php echo "" .isset($_SESSION['UserID']);?></label>
	 	   ...
	 	   <label> Email : <?php echo $col['Email']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Nombre : <?php echo $col['Name']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Direccion : <?php echo $col['Address']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Numero de contacto : <?php echo $col['ContactNumber']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Tipo de sangre : <?php echo $col['Bloodtype']; ?></label>
	 	   	 	   <br>
	 	   <br>
		...
		<button type="submit" name="treatmentHistory" class="btn" style=" border-radius: 5px;margin-left: 80%; border:none;padding: 10px 20px 10px 20px">Mi historial de tratamiento</button>

	...
	<h1>Doctor<span>Paciente</span></h1>
		...
		<ul> 
			...
			<li><a href="feedback.php">FeedBack</a></li>
  			...
  			<li><a href="Doctorpatient.php">Cerrar Sesion</a></li>
...
<div class="input-groupA">
	<label>Categoria</label>
	   	<select name="addcategory" class="xd">
	   		<option value="bone" >Huesos</option>
	   		<option value="heart">Cardiologo</option>
	   		<option value="Dentistry">Dentista</option>
	   		<option value="MentalHealth">Salud Mental</option>
	   		<option value="Surgery">Cirujano</option>
